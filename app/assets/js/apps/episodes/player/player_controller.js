      ...
      return Player.Controller = {
        showControls: function() {
          ...
          this.initializePlayer = function() {
            return require(["entities/feed"], playerData = self.defaultPlayerState(), self.audioPlayer.createAudio(), self.updateAudio());
          };
          ...
          this.newPlayerData = function(newModelData) {
            var newPlayerData;
            return require(["entities/feed"], newPlayerData = new Swabcast.Entities.Episode({
          ...
          this.defaultPlayerState = function() {
            var defaultData;
            return require(["entities/feed"], defaultData = new Swabcast.Entities.Episode({
